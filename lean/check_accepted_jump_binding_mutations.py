#!/usr/bin/env python3
"""Require both accepted-frame premises in the accepted JUMP theorem."""
...
source = Path(__file__).with_name("LeanVMBMinCore") / "AcceptedJump.lean"
...
for name, replacement in mutations.items():
    with tempfile.TemporaryDirectory(prefix="lsc1-accepted-jump-mutation-") as directory:
        candidate = Path(directory) / "AcceptedJump.lean"
