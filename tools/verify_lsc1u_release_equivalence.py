#!/usr/bin/env python3
"""Verify the pinned v0.1.1 physical netlist without checking it into Git."""
import argparse, hashlib, pathlib, shutil, subprocess, zipfile
...
def main():
    ...
    archive=cache/f"tt_submission-{ARTIFACT_ID}.zip"
    ...
    run(["yosys","-p",("read_verilog -sv gf2n_mul_bitstream.sv gf128_mul_bitstream.sv "
        ...
        "-set-at 2 uio_oe 182 -show rst_n,ena,uio_oe")],cwd=stage)
