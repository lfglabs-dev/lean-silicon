...
module tb_lsc1_packet_vector;
    ...
    task automatic run_request(input [1023:0] path, input integer length,
        ...
        begin
            ...
            $display("RTL_SCALAR_RESULT pending=%0d txn_id=%08x result_crc=%08x next_pc=%08x next_fp=%08x write_count=%0d write_address=%08x write_value=%032x",
                     dut.result_pending, dut.staged_txn_id, dut.staged_result_crc,
                     dut.staged_next_pc, dut.staged_next_fp, dut.scalar_staged_write_count,
                     dut.scalar_staged_write_address, dut.scalar_staged_write_value);
