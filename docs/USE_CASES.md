...
Mac persists memory and proof material; LSC-1 returns a compact scalar
transition result.  An ULX3S may observe and replay these exact byte handshakes for
