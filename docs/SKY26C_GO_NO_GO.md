...
| Formal and CI | Exact-head CI run [31203930126](https://github.com/lfglabs-dev/lean-silicon/actions/runs/31203930126), head `741a2073e0d341a15bb130b1d75295bbceb138df`, success. Its formal/lint job proves the checked-in bounded and compositional properties described in `docs/PROOF_BOUNDARIES.md`. | Assumptions and per-harness bounds remain in force. There is no complete Lean-to-RTL correspondence proof. Crucially, `formal/lsc1u_netlist_eq.sby` compares RTL with the historical v0.1 netlist (SHA-256 `0c85d1afefddf1166e4b3047500f9c27a03ad7198c9c075f505c4536888c03c3`), not the selected v0.1.1 netlist above; no formal-equivalence claim is made for the selected physical payload. |
