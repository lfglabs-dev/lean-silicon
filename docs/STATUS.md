...
| ULX3S MinCore arithmetic path | historical physical run exercised the fixed-length MinCore UART image and compared arithmetic responses with its MinCore host oracle; it is not LSC-1 v1 packet-endpoint evidence | `docs/ULX3S_PHYSICAL_VALIDATION.md`, `docs/ULX3S_SMOKE_AND_UART.md`, `docs/MINCORE_UART_HOST.md` |
