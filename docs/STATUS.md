...
| ULX3S smoke and MinCore UART bitstreams | built reproducibly and RTL-simulated in PR #16; not physically exercised there | `fpga/ulx3s/`, `docs/ULX3S_SMOKE_AND_UART.md` |
| ULX3S restricted program runner | uses PR #16's maintained 1 Mbaud driver; deterministic integration tests, no maintained-bitstream physical run | `fpga_harness/host/mincore_program.py` |
