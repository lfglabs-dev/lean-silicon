...
| ULX3S packet path | exercised on a physical ULX3S board against the host oracle for its documented packet-path scope; this is validation evidence, not an end-to-end or silicon claim | `docs/ULX3S_PHYSICAL_VALIDATION.md`, `fpga_harness/host/lsc1_packet_uart.py`, `docs/PROOF_BOUNDARIES.md` |
