...
| `full_lsc1_jump_bridge.sby` | Exact frontend safety through 20 cycles plus a byte-exact accepted taken JUMP, complete RESULT drain (depth 5571), matching RETIRE (depth 5591), and subsequent quiescent exactly-once witness (depth 5592) | arbitrary-traffic BMC + three lifecycle BMC sub-goals with non-vacuity covers + preserved end-to-end cover |
