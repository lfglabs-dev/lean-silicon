...
| `full_lsc1_deref_bridge.sby` | Exact frontend safety through 20 cycles plus a byte-exact accepted DEREF_CELL, complete RESULT drain (depth 2767), matching RETIRE (step 2786, depth 2787), and subsequent quiescent exactly-once end-to-end witness (depth 2788) | arbitrary-traffic BMC + three lifecycle BMC sub-goals with non-vacuity covers + preserved end-to-end cover |
| `full_lsc1_jump_bridge.sby` | Exact frontend safety through 20 cycles plus a byte-exact accepted not-taken JUMP, complete RESULT drain (depth 155), matching RETIRE (depth 175), and subsequent quiescent exactly-once witness (depth 176) | arbitrary-traffic BMC + three lifecycle BMC sub-goals with non-vacuity covers + preserved end-to-end cover |
