...
| `full_lsc1_deref_bridge.sby` | Exact frontend safety through 20 cycles plus a byte-exact accepted DEREF_CELL, complete RESULT drain, emitted-byte CRC binding, matching RETIRE, and a subsequent quiescent exactly-once witness (depth 2787) | bounded BMC + cover |
