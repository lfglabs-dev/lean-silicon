...
| `full_lsc1_deref_bridge.sby` | Exact frontend safety through 20 cycles plus a byte-exact accepted DEREF_CELL, complete RESULT drain, emitted-byte CRC binding, and matching RETIRE witness (depth 2786) | bounded BMC + cover |
