...
generic RTL used by the 128-bit specialization and is configured to prove that the result after
eight accepted multiplier bits equals an independent schoolbook carry-less
